    ...
    <div class="modal-dialog modal-lg mt-0" style="max-width: 100%;max-height: 90vh;">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <button type="button" class="btn btn-primary" style="width:15%;" onclick="submitForm('unique_id1')"><strong>Print Patient Copy</strong></button>
                <button type="button" class="btn btn-dark" style="width:15%;" onclick="submitForm('unique_id2')"><strong>Print Doctor Copy</strong></button>
                <button type="button" class="btn btn-danger" style="width:20%;" ><strong>Send For Senior Validation</strong></button>
                <button type="submit" class="btn btn-success  mx-auto" style="width:40%;" ><strong>Save</strong></button></div>
                    </div>
                </div>
            </form>
        </div>
