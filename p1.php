            ...
            <form method="POST">
                <div class="modal-body" style="background-color: #E7EBE6;">
                    ...
                    <div class="row">
                        ...
                        <h1 class="heading">SoundSteps</h1> 
                        <h4 class="fw-bold">Dr. Junior Therapist</h4>
                        <h6 class="">Doctor Id : JT005 <span> For Any Queries</span></h6>

                        <h6 class="fw-bold"> <i class="bi bi-geo-alt-fill"></i><span> #10, Ali Yavar Jung National Institute,
                        <br> <span style="opacity:0%;">cho</span>Mumbai</span></h6>
                        <h6 class="fw-bold"> <i class="bi bi-telephone-fill"> </i><span> +91 9894703845</span></h6>
                        <h6 class="fw-bold"> <i class="bi bi-envelope-fill"> </i><span> SoundSteps@gmail.com</span></h6>
                    </div>
